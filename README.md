...
```bash
$ cortex install react-demo --save
```
...
```js
var react_demo = require('react-demo');
```
...
Creates a new react-demo instance.
...
### react-demo.&lt;method-name&gt;(arguments)
